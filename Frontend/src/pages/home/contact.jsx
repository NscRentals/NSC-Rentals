...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-slate-900 to-slate-700 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Contact Information */}
          <div className="lg:col-span-1 bg-white/10 backdrop-blur-md rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">info@nscrentals.com</p>
                  <p className="text-gray-300">support@nscrentals.com</p>
                </div>
              </div>
          ...
          {/* Contact Form */}
          <div className="lg:col-span-2 bg-white/10 backdrop-blur-md rounded-xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white/5 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        {/* Map Section */}
        <div className="mt-16 bg-white/10 backdrop-blur-md rounded-xl shadow-lg p-8">
