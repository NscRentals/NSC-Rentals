      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {jobListings.map((job, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-md rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  {job.icon}
                  <h3 className="ml-3 text-xl font-semibold text-white">{job.title}</h3>
                </div>
        ...
        {/* Benefits Section */}
        <div className="mt-16 bg-white/10 backdrop-blur-md rounded-lg shadow-lg p-8">
          <h2 className="text-3xl font-bold text-white mb-6">Why Join NSC Rentals?</h2>
